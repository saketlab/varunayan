...
MOCK_SINGLE_DATASET = {
    ...
    'wind_variables': [
        {'name': 'wind_speed', 'description': 'Wind speed variable'}
    ]
}
...
def single_level_processed():
    return [
        {'name': 'temp', 'description': 'Temperature variable', 'category': 'temperature_and_pressure', 'dataset': 'single'},
        {'name': 'pressure', 'description': 'Pressure variable', 'category': 'temperature_and_pressure', 'dataset': 'single'},
        {'name': 'wind_speed', 'description': 'Wind speed variable', 'category': 'wind_variables', 'dataset': 'single'}
    ]

@pytest.fixture
def pressure_level_processed():
    return [
        {'name': 'pressure_lev1', 'description': 'Pressure level 1', 'category': 'pressure_levels', 'dataset': 'pressure'},
        {'name': 'pressure_lev2', 'description': 'Pressure level 2', 'category': 'pressure_levels', 'dataset': 'pressure'}
    ]
